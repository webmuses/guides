...
**Upewnij się, że masz zainstalowane Ruby on Rails.** [**Zobacz przewodnik instalacji**](/instalacja).
...
<h3>Terminal (Wiersz polecenia na systemie Windows)</h3>
...
Firefox, Safari, Chrome lub inna do obejrzenia Twojej aplikacji.
